...
public class SignUpActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dob_selector.setOnClickListener(view -> showDatePicker());
...
//        });
        ...
        findViewById(R.id.entireOption).setOnClickListener(view -> option.performClick());
                ...
                if(title.equals("nuller")){
                    ...
                    if(name.getText().toString().trim().equals("")){
                        ...
                        findViewById(R.id.ourScroller).setAlpha(0.3f);
                            ...
                            mAuth.createUserWithEmailAndPassword(email.getText().toString().trim(), password.getText().toString().trim()).addOnCompleteListener(task -> {
                                if(task.isSuccessful()){
                                    switch (title) {
                                        case "PHYSICIAN":
                                            try {
                                                PhysicianTree newUser = new PhysicianTree(name.getText().toString().trim(), email.getText().toString().trim(),
                                                        title, country, dob_selector.getText().toString().trim(), "null", "not set yet", "not set yet",
                                        ...
                                        case "PATIENT":
                                            try {
                                                PatientTree newUser = new PatientTree(name.getText().toString().trim(), email.getText().toString().trim(),
                                                        title, country, dob_selector.getText().toString().trim(), "null", "null", "NO", new ArrayList<>(),
                                                        new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
                                                FirebaseUser user = mAuth.getCurrentUser();
                                                databaseReference.child("users").child(user.getUid()).setValue(newUser);
                                                findViewById(R.id.progressBar).setVisibility(View.GONE);
                                        ...
                                        case "CAREGIVER":
                                            try {
                                                CaregiverTree newUser = new CaregiverTree(name.getText().toString().trim(), email.getText().toString().trim(),
                                                        title, country, dob_selector.getText().toString().trim(), "null", new ArrayList<>(), new ArrayList<>(),
